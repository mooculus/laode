...
\]
is a linear mapping.  Then compute the null space$\left(\frac{d^2}{dt^2}\right)$
and range$\left(\frac{d^2}{dt^2}\right)$.
...
\]
It follows that $L$ is a linear mapping.  Then null space is
\[
\{p\in  {\cal P}_4: p_0=p_1=0\} 
\]
and range($L$) is ${\cal P}_2$.
\end{solution}
\end{exercise}
