...
\begin{tabbing}
 \hspace{1.1in} \= \\
     ...
     $\dagger${\tt dfield5}  \index{\computer!dfield5} \>
...
\>			autonomous differential equations \\
       ...
       $\dagger${\tt pplane5}  \index{\computer!pplane5} \>
...
>>>>>>> 4968a3fd0544d5deed1e3645f254ab697c850f90
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\iflabelexists{Chap:HDeigenvalues}{
