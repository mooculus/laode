...
%\[X(t) =  e^{-t} \Matrix{ 1 \\ -1} + e^{3t}\Matrix{ 1 \\ 1 }\]

\begin{figure}[htb]
           \centerline{%
           \psfig{file=exfigure/A6.4.1a.eps,width=2.0in}}
%	   \psfig{file=exfigure/A6.4.1b.eps,width=2.0in}}
           \exercap{A6.4.1}
\end{figure}
...
\begin{figure}[htb]
           \centerline{%
           \includegraphics[height=2.5in]{exfigure/A6.4.2a.eps,width=2.0in}}
           \exercap{A6.4.2}
\end{figure}
\end{solution}
\end{exercise}
...
\begin{figure}[htb]
           \centerline{%
           \psfig{file=exfigure/A6.4.3a.eps,width=2.0in}}
           \exercap{A6.4.3}
\end{figure}
\end{solution}
\end{exercise}
