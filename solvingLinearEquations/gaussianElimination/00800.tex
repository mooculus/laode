...
(b) One variable ($x_3$) can be assigned arbitrary values.
...
(b) Two variables ($x_3$ and $x_4$) can be assigned arbitrary values.


\soln The row reduced form of the matrix is
$\left(\begin{array}{cccc|c} 1 & 0 & 2 & 0 & 3 \\ 0 & 1 & 2/3 & 1/3 & 10/3 \\
