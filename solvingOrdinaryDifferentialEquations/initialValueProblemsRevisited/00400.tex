...
%\begin{itemize}
%\item[(a)]  
%Use {\pplane} to find $X(0.5)$.  
%{\bf Hint}: Use the lower right {\sf Appearance} window in {\pplane} to compute the solution from $t_{min} = 0$ to $t_{max}=0.5$. Then use the {\sf zoom in square} 
...
%and the two methods agree to three decimal places.
...
\begin{solution}
\ans $X(0.5) = (1.621,0.291)^t$ %and the two methods agree to three decimal places.
