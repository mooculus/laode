...
\[
\vectwo{1}{4} = X(0) = \alpha_1\vectwo{1}{1} + \alpha_2\vectwo{1}{0} =
...
\end{array}
\]
we obtain $\alpha_1 = 4$ and $\alpha_2 = -3$ and write the
...
\end{array}
\]
we obtain $\alpha_1 = 3$ and $\alpha_2 = -2$ and write the
specific solution to the differential equation:
\[
X(t) = 3e^{2t}\vectwo{1}{0} - 2e^{-t}\vectwo{1}{1}.
\]
...
= \frac{1}{3}\cvectwo{7e^t - 10e^{-2t}}{14e^t - 5e^{-2t}}.
\]
...
and write the specific solution to the differential equation: 
\[
X(t) =\frac{7}{3}e^t\vectwo{1}{2} -\frac{5}{3}e^{-2t}\vectwo{2}{1}.
\]
