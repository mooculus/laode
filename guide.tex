...
Submit a separate \LaTeX\ file for each exercise.  It would be helpful
if you use the format provided at
...
answer).  MATLAB exercises should be marked as such.  Include a
suggestion for the most appropriate section of the textbook, and which
existing exercise in that section your problem ought to follow.
