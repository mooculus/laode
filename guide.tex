...
First, download the \LaTeX\ files for the textbook.
...
Then, download the worksheet builder.  The result will be a directory
...
contributions will be a tremendous help in reaching this goal.

It is best if you submit a separate \LaTeX\ file for each exercise.
Include a suggestion for the most appropriate section of the textbook,
and which existing exercise in that section your problem ought to
follow.  It would be helpful if you use the format provided at
...
answer).  MATLAB exercises should be marked as such.  
