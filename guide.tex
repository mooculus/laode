...
new exercise.  It would be helpful if you use the format provided at
...
Please include the section in which the new exercise should appear and the label of the existing exercise after which the new exercise should appear. 
