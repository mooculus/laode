...
Submit a separate file for each exercise following the format provided
at
\href{https://github.com/mooculus/laode/blob/master/howToContribute/template.tex}{\texttt{template.tex}}.

The file should include the exercise written in \LaTeX, and below it
the solution (preferably including an answer).  MATLAB exercises
should be marked as such.  Include a suggestion for the most
appropriate section of the textbook, and which existing exercise in
that section your problem ought to follow.
