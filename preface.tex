...
planar systems of autonomous differential equations called {\pplane}.  
%Until Chapter~\ref{C:HDS}
We use {\pplane} (and a companion code 
{\dfield}) instead of using the \Matlab native commands for solving ODEs. 
