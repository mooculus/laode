...
\begin{proof} We verify \eqref{e:proddetE} for each of the three types of
...
As we saw earlier \eqref{e:swapdecomp}, $E$ is the product of four
...
$R$ is identically zero.  Hence $D(R)=0$ and \eqref{e:proddetE}
implies that $D(A)=0$.  
