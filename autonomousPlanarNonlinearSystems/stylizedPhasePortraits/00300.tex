...
\input{../../preamble.tex}
\begin{document}
\begin{computerExercise} \label{c8.4.2}
...
Use {\pplane} to graph the system and find equilibria.  The
...
\end{verbatim}
Figure~\ref{c8.4.2} shows a {\pplane} graph of the system.

\begin{figure}[htb]
                       \centerline{%
                       \includegraphics[width=3.0in]{exfigure/8-4-2.pdf}}
                \exercap{c8.4.2}
\end{figure}
