...
MATLAB and loaded the course files, go to the directory containing the
course files.  Then enter \verb|pplane9| into the MATLAB command
window to verify that \verb|pplane9| works.
