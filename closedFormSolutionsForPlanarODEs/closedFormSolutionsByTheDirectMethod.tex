...
eigenvectors of $C$, that is, $Cv_j = \lambda_1 v_j$.  It follows
from linearity that $Cv = \lambda_1 v$ for any linear combination
...
combination of $v_1$ and $v_2$.  Therefore, $C$ is $\lambda_1$ times
the identity matrix.  
\end{proof}
