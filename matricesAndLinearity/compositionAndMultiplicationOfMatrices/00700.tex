...
Exercise \ref{YZ_3.5_Permu1} - \ref{YZ_3.5_Permu8} discuss \textit{permutation matrices}\index{matrix!permutation}: $n\times n$ matrices that have exactly one $1$ in each row and each column, and whose remaining entries are $0$. 
